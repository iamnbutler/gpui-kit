...
//     Edges, Element, ElementId, EventEmitter, FocusHandle, FocusableView, GlobalElementId,
//     HighlightStyle, Hitbox, Hsla, InputHandler, InteractiveElement, Interactivity, IntoElement,
//     LayoutId, Model, ModifiersChangedEvent, MouseButton, ParentElement, Pixels, Point, Render,
//     SharedString, Size, StatefulInteractiveElement, Styled, TextRun, TextStyle, ViewContext,
//     WindowContext, WindowTextSystem, WrappedLine,
// };
...
// struct LayoutRow {
//     point: Point<Pixels>,
//     text: gpui::WrappedLine,
// }

// impl LayoutRow {
//     fn new(point: Point<Pixels>, text: gpui::WrappedLine) -> Self {
//         Self { point, text }
//     }
...
// impl LayoutRect {
//     fn new(point: Point<Pixels>, num_of_chars: usize, color: Hsla) -> LayoutRect {
//         LayoutRect {
//             point,
//             num_of_chars,
//             color,
...
//         LayoutRect {
//             point: self.point,
//             num_of_chars: self.num_of_chars + 1,
//             color: self.color,
//         }
//     }
...
//         };
//         let size = point(
//             (layout.dimensions.width * self.num_of_chars as f32).ceil(),
...
//                 // This shouldn't be init every time
//                 // but should be retrieved from somewhere
//                 let styles = Styles::init(cx);
